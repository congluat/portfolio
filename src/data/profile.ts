export const profile = {
  ...
  skills: [
    ...
    { name: 'Kafka', level: 85, category: 'Messaging' },
    { name: 'Redis', level: 83, category: 'Database' },
    { name: 'OpenSearch / Splunk', level: 80, category: 'Observability' },
  ],
  languages: [
  ...
  experience: [
    {
      ...
      highlights: [
        ...
        'Contributed to platform modernization initiatives using cloud-native patterns on Azure and Kubernetes',
      ],
      tech: ['Java', 'Spring Boot', 'Azure', 'Kubernetes', 'Kafka', 'PostgreSQL', 'Redis', 'OpenSearch', 'Splunk', 'Microservices'],
      featured: true,
    },
    {
      company: 'TIKI',
